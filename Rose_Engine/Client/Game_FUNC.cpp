/*
	$Header: /Client/Game_FUNC.cpp 57    07-04-30 2:53p Raning $
*/
#include "stdAFX.h"
#include "IO_Effect.h"
#include "OBJECT.h"
...
/// 선물 상자 성공
void SE_SuccessGiftBox ( int iObject )
{
	int iResult = Call_Char_Lua_Func( iObject, "SE_SuccessGiftBox" );
}

// 클랜전 승리 폭죽
void SE_Congratulation( int iObject )
{
	int iResult = Call_Char_Lua_Func( iObject, "SE_Congratulation" );
}
