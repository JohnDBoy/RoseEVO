...
public:
	...
	enum MAKE_TYPE{
		...
		FACE_TYPE,				/// 얼굴
		GEM_TYPE		= 35,	/// 보석
		INDUSTRY_TYPE	= 36,	/// 공산품
		

		SEPERATE_TYPE	= 41,	/// 분해
		UPGRADE_TYPE	= 42,	/// 제련
		
		HIGH_SWORD_TYPE  = 51,	/// 상급 검
		HIGH_BLUNT_TYPE,		/// 상급 둔기
		HIGH_BOW_TYPE,				/// 상급 활
		HIGH_PISTOL_TYPE,			/// 상급 총
		HIGH_MAGICWEAPON_TYPE,		/// 상급 매직무기
		HIGH_SUBEQUIP_TYPE,			/// 상급 보조장비
		HIGH_BATTLEARMOR_TYPE,		/// 상급 전투복장
		HIGH_MAGICARMOR_TYPE,		/// 상급 매직복장
		HIGH_NORMALARMOR_TYPE,		/// 상급 일반복장
		HIGH_POTION_TYPE		= 60,	/// 상급 포션.		
