...
void CChatMember::SetUserTag( DWORD dwUserTag )
{
...
void CChatRoom::SetPassword( const char* pszPassword )
{	
	if(pszPassword)
	{
...
const char* CChatRoom::GetPassword()
{
	if(m_strPassword.length()==0)	return NULL;
