...
#define	MAX_LEVEL				260		// 200 최대 레벨을 250으로 수정
...
#else
#define MAX_SKILL_TAB		4       //직업스킬-0,파츠스킬-1,유니크스킬-2
#endif
...
#ifdef __MILEAGESKILL
	short m_nMileageSkill[MAX_MILEAGE_SKILL];		//마일리지 스킬
#endif
...
public :
	...
	short	Quest_Append_9( int iQuestIDX );						// 2006-08-31  오후 5:21:23 - 김영환
