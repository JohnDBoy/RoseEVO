/*
$Header: /Client/CCamera.cpp 40    07-06-28 3:03p Kjhpower $
*/
#include "stdAFX.h"
#include "CCamera.h"
#include "Game.h"
...
#ifndef _DEBUG
#define	MAX_DISTANCE	( 2640.f * ((g_GameDATA.m_bFilmingMode)? 2.0f : 1.0f) )
#else
#define	MAX_DISTANCE	( 294000 )
#endif                   
...
void CCamera::Set_Distance (float fDistance)
{
	m_fDistance = fDistance;	
}