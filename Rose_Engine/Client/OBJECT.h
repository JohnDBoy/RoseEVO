/*
	$Header: /Client/OBJECT.h 36    06-12-04 10:25a Choo0219 $
*/
#ifndef	__OBJECT_H
#define	__OBJECT_H
...
public :
	...
	///STB INDEX로 캐릭터 오브젝트를 얻는다.
	CObjCHAR*	Get_ClientCharOBJBySTBIndex( int iStbIndex );
	...
	void        OpeningCollisionNPCMotion();	
	void 		ClosedCollisionNPCMotion();   
	void        OpenedCollisionNPCMotion();
	void        ResponseCollisionNPC(int iMotionIDX);
