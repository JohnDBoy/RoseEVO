...
public:
	...
	enum{
		...
		IID_BTN_ABANDON1	= 51,											/// 퀘스트 포기 버튼
		IID_BTN_ABANDON2	= 52,											/// 퀘스트 포기 버튼
		IID_BTN_ABANDON3	= 53,											/// 퀘스트 포기 버튼
		IID_BTN_ABANDON4	= 54,											/// 퀘스트 포기 버튼
...
protected:
	...
	int  GetSelectQuestIdx(int iSelectedItemIndex);
	void Minimize();														/// 최소화
	void Maximize();														/// 최대화
