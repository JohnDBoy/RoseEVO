...
void CEventDialog::SetScript( char* pszScript )
{
	...
	else
	{
		...
		int iWidth		= 244;
		int iLineHeight = 21;
		int iImageID    = CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_UPSIDE_MIDDLE" );
		...
		iImageID		= CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_UPSIDE_BOTTOM" );
		iLineHeight     = 12;
		...
		iImageID = CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_UNDERSIDE_TOP" );
		iLineHeight  = 10;
		iWidth   = 244;
		...
		iImageID = CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_UNDERSIDE_BOTTOM" );
		iLineHeight  = 12;
		pAnswerItem = new CDialogNpcScriptAnswerItem( 0, NULL , 0 , NULL ,iImageID, iLineHeight , iWidth );
		pListBox->Add( pAnswerItem ); iAnswerListBoxHeight += pAnswerItem->GetHeight();


		iImageID = CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_FOOT" );
		iLineHeight  = 3;
		pAnswerItem = new CDialogNpcScriptAnswerItem( 0, NULL , 0 , NULL ,iImageID, iLineHeight , iWidth );
		pListBox->Add( pAnswerItem ); iAnswerListBoxHeight += pAnswerItem->GetHeight();
...
void CEventDialog::AddAnswerExample( char* pszScript , int iEventID , void (*fpEventHandle)(int iEventID))
{
	...
	else
	{
		...
		int iImageID = CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "EVENT_DIALOG_UNDERSIDE_MIDDLE" );
		int iHeight  = 20;
		int iWidth	 = 244;
