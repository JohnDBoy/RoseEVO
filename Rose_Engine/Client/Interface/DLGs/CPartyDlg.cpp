...
void CPartyDlg::Show()
{
	...
	m_iGuagePartyExpIdx		= CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "UI18_GUAGE_PARTYLEVEL");
	m_iGuagePartyExpBGIdx	= CResourceMgr::GetInstance()->GetImageNID( UI_IMAGE_RES_ID, "UI18_GUAGE_PARTYLEVEL_BASE");
...
void CPartyDlg::Draw()
{
	...
	drawFont( g_GameDATA.m_hFONT[ FONT_NORMAL_BOLD ], true, 35,  7, g_dwWHITE, STR_PARTY );
	...
	g_DrawImpl.Draw( m_sPosition.x + 96, m_sPosition.y + 34, UI_IMAGE_RES_ID, m_iGuagePartyExpBGIdx );
	g_DrawImpl.Draw( m_sPosition.x + 96, m_sPosition.y + 34, nWidth, UI_IMAGE_RES_ID,  m_iGuagePartyExpIdx );
