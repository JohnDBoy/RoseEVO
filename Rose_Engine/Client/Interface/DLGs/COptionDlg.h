...
protected:
	enum{
		...
		IID_COMBO_ANTIALIASING	= 37, //Raven: AntiAliasing added
		IID_TABBUTTON_PLAY		= 42,
		IID_RADIOBOX_CONTROL	= 43,

		IID_RADIOBUTTON_DEFAULTCONTROL		= 45,
		IID_RADIOBUTTON_SEVENHEARTSCONTROL	= 44,
		...
		IID_RADIOBOX_PICKUP			= 80,
		IID_RADIOBTN_PICKUP_ON		= 81,
		IID_RADIOBTN_PICKUP_OFF		= 82,
		...
		IID_RADIOBOX_SHORTCUT		= 180,
		IID_RADIOBUTTON_SHORTCUT_SHOW	= 181,
		IID_RADIOBUTTON_SHORTCUT_HIDE	= 182,
...
protected:
	...
	t_OptionShortCut				m_ShortCutOption;
//	t_OptionAutoPickup				m_OptionAutoPickup;
