...
public:
	...
	void DrawOneImage( int x, int y );

	void Clear();
	void SetPosition( POINT pt );
	void SetPositionText( POINT pt );
...
//	void SetTitle( char* pszTitle );
	...
	void SetInfoType(int iType);

	void SetImage( int iModuleID, const char* szSID );
