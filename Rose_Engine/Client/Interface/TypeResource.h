...
#define STR_CRAFT_FAILED								CStringManager::GetSingleton().GetString( 37 )  // 제련 실패로 아이템이 사라졌습니다.
...
#define STR_CLAN_QUERY_BAN_M							CStringManager::GetSingleton().GetString( 92 )
...
#define STR_CLAN_QUERY_BAN_S							CStringManager::GetSingleton().GetString( 99 )
...
#define STR_ITEMGRADE								CStringManager::GetSingleton().GetString( 229 ) /// 아이템 등급
...
#define STR_CANT_CAST_NEARNPC						CStringManager::GetSingleton().GetString( 386 ) ///NPC 주위에서는 스킬 시전이 불가능합니다.
#define STR_CANT_CAST_NPC							CStringManager::GetSingleton().GetString( 387 ) ///NPC에게는 스킬 시전이 불가능합니다.
...
#define	STR_NOITEM_CANT_UPGRADED					CStringManager::GetSingleton().GetString( 450 )//제련할 아이템이 없습니다. 아이템을 올려주세요.
#define STR_NOITEM_MATERIAL							CStringManager::GetSingleton().GetString( 451 )//제련 재료가 아닙니다.
#define	STR_NO_USE_EQUIPITEM						CStringManager::GetSingleton().GetString( 452 )//장착 아이템에는 사용할 수 없습니다.
#define STR_MAKESOCKET_SUCCESS						CStringManager::GetSingleton().GetString( 453 )// 소켓을 뚫는데 성공했습니다.
#define	STR_MAKESOCKET_FAILED						CStringManager::GetSingleton().GetString( 454 )// 소켓을 뚫는데 실패했습니다.
...
#define	STR_BILLING_MSG_FREE_USER				CStringManager::GetSingleton().GetString( 592 )//         귀하는 무료 사용자 입니다
...
#define STR_EXPIRED_TIME						CStringManager::GetSingleton().GetString( 618 )  // 만료시간
...
//kor, ph billing msg
#define STR_FREE_ACCOUNT_USER					CStringManager::GetSingleton().GetString( 718 )	   // 평생무료 사용자입니다.
#define STR_PAID_DAYBASED_PLAN					CStringManager::GetSingleton().GetString( 719 )	   // 개인 정액 사용자입니다.
#define STR_PAID_DAYBASED_PLAN_PLATINUM			CStringManager::GetSingleton().GetString( 720 )	   // 개인정액(플래티넘) 사용자입니다.

#define STR_PAID_TIMEBASED_PLAN					CStringManager::GetSingleton().GetString( 721 )	   // 개인 정량 사용자 입니다.
#define STR_PAID_INTERNET_CAFE					CStringManager::GetSingleton().GetString( 722 )	   // 게임방 사용자로 접속되었습니다.
#define STR_PAID_USER_PLAN_IC_TIME_END			CStringManager::GetSingleton().GetString( 723 )	   // 게임방의 과금기간(시간)이 만료되어 개인정량으로 접속되었습니다.
#define STR_PAID_USER_PLAN_IC_IP_FULL			CStringManager::GetSingleton().GetString( 724 )	   // 게임방의 접속 가능 IP숫자를 넘어 개인정량으로 접속되었습니다.

#define STR_GAME_TIME_LEFT_MINS					CStringManager::GetSingleton().GetString( 725 )		// 사용시간이 %d분 남았습니다.
...
#define STR_ITEM_TIME_OUT						CStringManager::GetSingleton().GetString( 918 )		// %s을 %d년 %d월 %d일 %d시까지 사용가능합니다

// Begin - Antonio - 2006-07-24  오전 11:18:21
// 클랜전 관련 문자열
#define STR_CLANWAR_JOIN_REQ					CStringManager::GetSingleton().GetString( 920 )		// 클랜전 요청 메시지
#define STR_CLANWAR_JOIN_REQ_RECONFIRM_M		CStringManager::GetSingleton().GetString( 921 )		// 클랜전 요청 재확인 메시지 (클랜장)
#define STR_CLANWAR_JOIN_REQ_RECONFIRM_S		CStringManager::GetSingleton().GetString( 922 )		// 클랜전 요청 재확인 메시지 (클랜원)
#define STR_CLANWAR_ABSTENTION					CStringManager::GetSingleton().GetString( 923 )		// 상대 클랜 포기 메시지
#define STR_CLANWAR_QUEST_LIST_FULL				CStringManager::GetSingleton().GetString( 924 )		// 퀘스트 목록 가득 찼을 때 메시지
#define STR_CLANWAR_START						CStringManager::GetSingleton().GetString( 930 )		// 클랜전 시작 메시지
#define STR_CLANWAR_DESC						CStringManager::GetSingleton().GetString( 931 )		// 클랜전 설명 메시지
#define STR_CLANWAR_KILLED_BLUE_DRAGON			CStringManager::GetSingleton().GetString( 932 )		// 클랜전 블루 드래곤 사망 메시지
#define STR_CLANWAR_KILLED_RED_DRAGON			CStringManager::GetSingleton().GetString( 933 )		// 클랜전 레드 드래곤 사망 메시지
#define STR_CLANWAR_WAS_DRAWN					CStringManager::GetSingleton().GetString( 934 )		// 클랜전 비겼을 경우 메시지
#define STR_CLANWAR_END_RETURN					CStringManager::GetSingleton().GetString( 935 )		// 클랜전 종료 후 복귀 메시지
#define STR_CLANWAR_NOTIFY_CANCEL				CStringManager::GetSingleton().GetString( 937 )		// 클랜전 취소 통보
#define STR_CLANWAR_MOVE_CHANNEL				CStringManager::GetSingleton().GetString( 938 )		// 클랜전 채널 이동 메시지 (-> 채널 x)
#define STR_CLANWAR_OFFER_MISLEVEL				CStringManager::GetSingleton().GetString( 939 )		// 클랜전 신성시 클랜장의 Level 제한으로 신청 불가할 때
#define STR_CLANWAR_ENTER_MISLEVEL				CStringManager::GetSingleton().GetString( 940 )		// 클랜전 Level 제한으로 입장 불가할 때

// 퀘스트 관련 문자열
// End   - Antonio

#define STR_GETTING_GIFTBOX						CStringManager::GetSingleton().GetString( 925 )		// 선물을 획득하였습니다.
#define STR_NOTENOUGH_INVENTORY_SLOT			CStringManager::GetSingleton().GetString( 936 )		// 인벤토리에 있는 장비, 소모, 재료 탭에 최소 4칸의 공간이 필요합니다.

#define STR_ENOUGH_STAT_POINT					CStringManager::GetSingleton().GetString( 951 )		// 필요 스탯포인트
