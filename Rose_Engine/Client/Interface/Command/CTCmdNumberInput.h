...
/// 창고에 돈을 저금한다.
class CTCmdSaveMoneyFromBank : public CTCmdNumberInput
{
public:
	CTCmdSaveMoneyFromBank(){}
	virtual ~CTCmdSaveMoneyFromBank(){}
	virtual bool Exec( CTObject* pObj );
};

/// 창고에서 돈을 찾는다.
class CTCmdWithdrawMoneyFromBank : public CTCmdNumberInput
{
public:
	CTCmdWithdrawMoneyFromBank(){}
	virtual ~CTCmdWithdrawMoneyFromBank(){}
	virtual bool Exec( CTObject* pObj );
};
