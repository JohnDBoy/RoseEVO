...
void CCreateAvata::SetInterfacePos_After()
{
	CWinCtrl * pCtrl = NULL;
...
POINT	& CCreateAvata::GetCreateAvatarPos()
{
	return m_ptCreateAvatar;
}
SIZE	& CCreateAvata::GetCreateAvatarSize()
{
	return m_szCreateAvatar;
}
