...
protected:
	...
	std::list <std::string> m_warning;

	DWORD		m_dwSetMsgTime;			/// 이번 경고문을 보여주기 시작한 시간
	DWORD		m_dwSetMsgTimeSpace;	/// 다음 경고문을 보여주기까지의 시간

	std::list <std::string>::iterator m_listiter;
