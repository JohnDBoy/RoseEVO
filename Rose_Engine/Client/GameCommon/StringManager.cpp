...
#ifdef __SET_PREDEFINED_LANGUAGE

#if defined(__KOREA_NEW) || defined(__HEBAN) || defined(__ARUA)
	return LANGUAGE_KOR;
#endif

#if defined(__JAPAN_NEW)
	return LANGUAGE_JPN;
#endif

# if defined(_PHILIPPIN_EVO)
	return LANGUAGE_USA;
#endif

#if defined(_TALA_EVO)
	return LANGUAGE_USA;
#endif
...
stItemTypeTable* CStringManager::GetItemStringData( int iType, int iItemNo )
{
	...
	if( iItemNo < 1 || iItemNo > g_pTblSTBs[iType]->m_nDataCnt )
		return NULL; 
