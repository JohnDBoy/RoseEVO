...
//-------------------------------------------------------------------------------------------------
bool BCB_Socket::_Init (TCustomWinSocket *pSocket)
{
    m_nSendByte = 0;
    m_nRecvByte = 0;
...
//-------------------------------------------------------------------------------------------------
void BCB_Socket::PacketHandle (void)
{
    LogString (0xffff, "virtual BCB_Socket::PacketHandle() type: 0x%x, Size: %d ", m_pRecvPket->m_HEADER.m_wType, m_pRecvPket->m_HEADER.m_nSize);
}
