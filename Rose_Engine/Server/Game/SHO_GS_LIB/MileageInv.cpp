...
//-------------------------------------------------------------------------------------------------
/// Server function
short CMileageInv::AppendITEM (tagITEM &sITEM, short &nCurWeight)
{
...
short CMileageInv::AppendITEM (short nListRealNO, tagITEM &sITEM, short &nCurWeight)
{
	_ASSERT( sITEM.GetTYPE() );
...
void CMileageInv::SubtractITEM (short nListNO, tagITEM &sITEM, short &nCurWEIGHT)
{
...
short CMileageInv::FindITEM (tagITEM &sITEM)
{
