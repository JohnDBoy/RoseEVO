...
////	클랜 랭크 포인트 변경 : 김영환 추가
#define CLVAR_SET_RANKPOINT		0x06
// (20061221:남병철) : 클랜 보상 포인트 세팅
#define CLVAR_SET_REWARDPOINT	0x07
// (20070110:남병철) : 클랜전 보상 포인트 추가
#define CLVAR_ADD_REWARDPOINT	0x08
...
struct gsv_ADJ_CLAN_VAR : public t_PACKETHEADER {
	...
	// (20070319:남병철) : 클랜전 참여한 사람들의 이름 표기
	char	m_pNameList[1600];
} ;
