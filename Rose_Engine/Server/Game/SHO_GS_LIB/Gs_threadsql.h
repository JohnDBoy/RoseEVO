...
typedef std::vector<std::string> SQLList;
//-------------------------------------------------------------------------------------------------
...
//	classDLLIST< classUSER >	m_RunUserLIST;
	...
	bool Proc_KRRE_cli_SELECT_CHAR( tagQueryDATA *pSqlPACKET );
...
public :
	...
	bool UpdateBankRECORD( classUSER *pUSER);
	bool Update_KRRE_UserRECORD(classUSER *pUSER);
} ;
