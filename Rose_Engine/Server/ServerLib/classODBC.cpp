...
bool classODBC::GetTimestamp( WORD wColumnIDX, sqlTIMESTAMP *pTimeStamp )
{
	...
	pTimeStamp->m_btMon = static_cast<BYTE>(m_pColumn[ wColumnIDX ].m_SQL_TIMESTAMP.month);
	pTimeStamp->m_btDay = static_cast<BYTE>(m_pColumn[ wColumnIDX ].m_SQL_TIMESTAMP.day);
	pTimeStamp->m_btHour= static_cast<BYTE>(m_pColumn[ wColumnIDX ].m_SQL_TIMESTAMP.hour);
	pTimeStamp->m_btMin = static_cast<BYTE>(m_pColumn[ wColumnIDX ].m_SQL_TIMESTAMP.minute);
	pTimeStamp->m_btSec = static_cast<BYTE>(m_pColumn[ wColumnIDX ].m_SQL_TIMESTAMP.second);
