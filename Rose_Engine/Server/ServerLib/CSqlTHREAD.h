...
//	virtual void Execute() = 0;
	...
	bool Connect (BYTE btSqlTYPE, char *szServerIP, char *szUser, char *szPassword, char *szDBName, short nBindParamCNT=MAX_SQL_BIND_PARAMETER, WORD wQueryBufferLEN=MAX_SQL_QUERY_BUFFER);
	void Free ();
