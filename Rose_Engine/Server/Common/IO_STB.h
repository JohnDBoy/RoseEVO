...
// 모든 중분류 아이템의 공통
#ifdef __SERVER
	#define	ITEM_NAME(T,I)					ItemName(T,I)			// 아이템 이름
	#define ITEM_DESC(T,I)					ItemDesc(T,I)			// 아이템 설명
#else
...
#define	ITEM_TYPE(T,I)					ItemSTBGetData(T, I ,  4 )	// 아이템 종류 : 중분류?
#define	ITEM_BASE_PRICE(T,I)			ItemSTBGetData(T, I ,  5 )	// 기준가격
#define	ITEM_PRICE_RATE(T,I)			ItemSTBGetData(T, I ,  6 )	// 가격 변동률
#define	ITEM_WEIGHT(T,I)				ItemSTBGetData(T, I ,  7 )	// 무게
#define	ITEM_QUALITY(T,I)				ItemSTBGetData(T, I ,  8 )	// 품질
#define	ITEM_ICON_NO(T,I)				ItemSTBGetData(T, I ,  9 )	// 아이템 번호
#define	ITEM_FIELD_MODEL(T,I)			ItemSTBGetData(T, I , 10 )	// 필드 모델 데이타
#define	ITEM_EQUIP_SOUND(T,I)			ItemSTBGetData(T, I , 11 )	// 장착 효과음
#define	ITEM_MAKE_NUM(T,I)				ItemSTBGetData(T, I , 12 )	// 제조 번호
#define ITEM_SKILL_LEV(T,I)				ItemSTBGetData(T, I , 13 )	// 스킬 레벨
#define ITEM_PRODUCT_IDX(T,I)			ItemSTBGetData(T, I , 14 )	// 재료 번호
#define	ITEM_MAKE_DIFFICULT(T,I)		ItemSTBGetData(T, I , 15 )	// 제조 난이도
#define ITEM_TRADE_UNIONPOINT(T,I)		ITEM_MAKE_DIFFICULT(T,I)			// 조합상점에서 아이템 구입시 필요한 조합포인트

// 소모, 기타 아이템 공통
#define	ITEM_RATE_TYPE(T,I)				ItemSTBGetData(T, I , 16)	// 생필품 종류

// 장착 가능한 아이템의 공통
/*
#define	ITEM_JOB_TYPE_CNT				3
#define	ITEM_JOB_TYPE(T,I,C)			ItemSTBGetData(T, I , 16+C ]
#define	ITEM_JOB_TYPE1(T,I)				ItemSTBGetData(T, I , 16 ]	// 해당 직업1
#define	ITEM_JOB_TYPE2(T,I)				ItemSTBGetData(T, I , 17 ]	// 해당 직업2
#define	ITEM_JOB_TYPE3(T,I)				ItemSTBGetData(T, I , 18 ]	// 해당 직업3
*/
...
#define	ITEM_NEED_DATA_TYPE(T,I,C)		ItemSTBGetData(T, I , 19+(C*2) )	// 아이템 종류
#define	ITEM_NEED_DATA_VALUE(T,I,C)		ItemSTBGetData(T, I , 20+(C*2) )	// 아이템 종류
...
#define	ITEM_DURABITY(T,I)				ItemSTBGetData(T, I , 29 )	// 아이템 내구도

#define	ITEM_RARE_TYPE(T,I)				ItemSTBGetData(T, I , 30 )
#define ITEM_DEFENCE(T,I)				ItemSTBGetData(T, I , 31 )	// 방어력
#define ITEM_RESISTENCE(T,I)			ItemSTBGetData(T, I , 32 )	// 항마력

// UPGRADE_KRRE
#define ITEM_UPGRADE_NO(T,I)			ItemSTBGetData(T, I , 45 )	// 재련 번호
#define ITEM_UPGRADE_ITEMGRADE(T,I)		ItemSTBGetData(T, I , 46 )  // 재련시 아이템 등급
...
//	@Use ITEM_xxxx
#define	ARMOR_MAT_TYPE(I)				g_TblARMOR.GetData( I , 33 )		// 재질 타입
...
// UPGARDE_KRRE
#define UPGRADE_WEAPON_SUCPOS(I)		g_TblUPGRADE.GetData( I , 1 )		// 무기제련 성공 확률
#define UPGRADE_SUBWPN_SUCPOS(I)		g_TblUPGRADE.GetData( I , 3 )		// 방어구제련 성공 확률
...
#define	USEITEM_STORE_SKIN(I)				g_TblUSEITEM.GetData( I ,  8 )	// 개인상점 이미지 번호...
...
#define	USEITEM_ADD_DATA_TYPE(I)			g_TblUSEITEM.GetData( I , 19 )	// 아이템 종류
#define	USEITEM_ADD_DATA_VALUE(I)			g_TblUSEITEM.GetData( I , 20 )	// 아이템 종류
...
#define USEITEM_ALLPY_VALUE						USEITEM_ADD_DATA_VALUE               //아이템 적용 수치 가져옴...(드릴아이템 성공확률..)

#define	USEITEM_SCRIPT(I)					g_TblUSEITEM.GetData( I , 21 )
#define	USEITEM_USE_EFFECT(I)				g_TblUSEITEM.GetData( I , 22 )	// 사용 효과음
#define	USEITEM_USE_SOUND(I)				g_TblUSEITEM.GetData( I , 23 )	// 사용 효과음
#define	USEITME_STATUS_STB(I)				g_TblUSEITEM.GetData( I , 24 )	// 지속형 상태

//-------------------------------------
/*
#define	MAX_USEITEM_COOLTIME_TYPE			4	// 0~3
*/
// 2007.01.30/김대성/수정 - 쿨타임 타잎 최대값 늘림
...
//	@Use ITEM_xxxx
#define	GEMITEM_BASE_PRICE(I)				g_TblGEMITEM.GetData( I ,  5 )	// 기준가격
#define	GEMITEM_PRICE_RATE(I)				g_TblGEMITEM.GetData( I ,  6 )	// 가격 변동률
...
#define GEMITEM_MARK_IMAGE(I)				g_TblGEMITEM.GetData( I , 20 )	//마크이미지 
#define GEMITEM_ATTACK_EFFECT(I)			g_TblGEMITEM.GetData( I , 21 )	//아이텝에 붙을 이미지
...
//	@Use ITEM_xxxx
#define NATURAL_BULLET_NO(I)		g_TblNATUAL.GetData( I , 17 )///수정 2004 / 2 /18 :nAvy g_TblNPC => g_TblNATUAL
...
// (20070322:남병철)
// 조합 구분으로 사용 ( 0번 : 무소속, 1 ~ 10 조합 소속(LIST_UNION.stb 참조), 11 클랜상점)
...
#define	ATTRIBUTE_FORM(SA,NA)		g_TblATTR.GetData( NA , SA )				// SA:스킬속성, NA:npc속성
...
//////////한국 아이템 드랍 리뉴얼 버젼에서 추가(허재영 2005.11.15) ////////////////////////////////////
#define  DROP_TYPE_PER(I,T)    g_TblDropITEM.GetData( I ,T+1)       //드랍타입별루.. 확률 가져오기..(돈,아이템,월드)
...
*/
// 2007.01.18/김대성/수정 - 기획팀요청으로 최대값 수정
#define DEF_MAX_DROP_ENTRY		30
//-------------------------------------
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define	PRODUCT_RAW_MATERIAL(I)			g_TblPRODUCT.GetData( I , 1 )			// 원료 종류 번호

#define	PRODUCT_NEED_ITEM_NO(P,C)		g_TblPRODUCT.GetData( P , 2+(C)*2 )	// 재료 아이템 번호
#define	PRODUCT_NEED_ITEM_CNT(P,C)		g_TblPRODUCT.GetData( P , 3+(C)*2 )	// 필요 갯수

#define	PRODUCT_NEED_ITEM_TYPE_REN(P,C)		g_TblPRODUCT.GetData( P , 4+(C)*3 )	// 재료 아이템 번호
#define	PRODUCT_NEED_ITEM_NO_REN(P,C)		g_TblPRODUCT.GetData( P , 5+(C)*3 )	// 재료 아이템 번호
#define	PRODUCT_NEED_ITEM_CNT_REN(P,C)		g_TblPRODUCT.GetData( P , 6+(C)*2 )	// 필요 갯수
...
//한국 리뉴얼 아이템분해 (허재영 2005.11.1)
#define BREAK_ITEM_IDX(I,C)		g_TblBreak.GetData(I,2+(C)*3)			//분해아이템 인덱스
#define BREAK_ITEM_CNT(I,C)		g_TblBreak.GetData(I,3+(C)*3)			//분해아이템 갯수
#define BREAK_ITEM_PER(I,C)		 g_TblBreak.GetData(I,4+(C)*3)			//분해아이템 확률
#define BREAK_MAX_CNT(I)			 g_TblBreak.GetData(I,62)						//분해최대횟수
#define BREAK_ENTRY_ITEM_CNT(I)  g_TblBreak.GetData(I,63)						//분해등록아이템수..
...
extern STBDATA g_TblBreak;					//한국리뉴얼 아이템 분해..

extern STBDATA	g_TblUPGRADE;		/// 재련 - 리뉴얼
