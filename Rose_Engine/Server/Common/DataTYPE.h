...
#include <Windows.h>
#ifdef  __SHO_GS
//#pragma  COMPILE_TIME_MSG("&&&&&&&&&&&&&&&&  __SHO_GS     &&&&&&&&&&&&&&&&&&&&&&&")
#include "stdafx.h"
#endif
...
enum Mileage_Equip 
{
	M_EQUIP_IDX_FACE_ITEM=EQUIP_IDX_FACE_ITEM,
	M_EQUIP_IDX_HELMET,
	M_EQUIP_IDX_ARMOR,
	M_EQUIP_IDX_KNAPSACK,
	M_EQUIP_IDX_GAUNTLET,
	M_EQUIP_IDX_BOOTS,	
	M_EQUIP_IDX_WEAPON_R,
	M_EQUIP_IDX_WEAPON_L,	
	M_MAX_EQUIP_IDX		
} ;
...
#define MAX_MILEAGE_EQUIP 15            //마일리지 인벤 착용
#define MAX_MILEAGE_INV_SIZE  MAX_MILEAGE_EQUIP+INVENTORY_PAGE_SIZE  //총 마일리지 인벤저장수 (착용:15+저장:30)
...
enum t_eItemCLASS {
	...
	USE_ITEM_GIFT_BOX_ITEM			= 322,		// 선물박스 아이템 사용

	USE_ITEM_SKILL_RESET		= 323,		// 스킬 초기화 아이템 메시지
...
enum t_AbilityINDEX {
	...
	AT_PSV_RES,									// 항마력
	AT_PSV_HIT,									// 명중률
	AT_PSV_CRITICAL,							// 크리티컬
	AT_PSV_AVOID,								// 회피
	AT_PSV_SHIELD_DEF,							// 방패 방어
	AT_PSV_IMMUNITY,							// 면역력
	AT_PSV_NEW_ATK_POW_1HAND_SWD,                //한손 검무기공격력
	AT_PSV_NEW_ATK_POW_1HAND_MACE,				//둔기
	AT_PSV_NEW_ATK_POW_2HAND_SWD,				//양손검 
	AT_PSV_NEW_ATK_POW_SPEAR,							//창
	AT_PSV_NEW_ATK_POW_AXE,									//도끼
	AT_PSV_NEW_ATK_POW_BOW,								//활
	AT_PSV_NEW_ATK_POW_GUN,								//총
	AT_PSV_NEW_ATK_POW_LAUNCHER,				    //런쳐
	AT_PSV_NEW_ATK_POW_TWIN_GUN,						//쌍총
	AT_PSV_NEW_ATK_POW_STAFF,							//지팡이
	AT_PSV_NEW_ATK_POW_WAND,							//완드
	AT_PSV_NEW_ATK_POW_KATAR,							//카타르
	AT_PSV_NEW_ATK_POW_TWIN_SWD,				   //이도류
	AT_PSV_NEW_ATK_POW_CROSSBOW,				  //석궁
	AT_PSV_NEW_ATK_SPD_1HAND_SWD,                //한손 검무기공격력
	AT_PSV_NEW_ATK_SPD_1HAND_MACE,				//둔기
	AT_PSV_NEW_ATK_SPD_2HAND_SWD,				//양손검 
	AT_PSV_NEW_ATK_SPD_SPEAR,							//창
	AT_PSV_NEW_ATK_SPD_AXE,									//도끼
	AT_PSV_NEW_ATK_SPD_BOW,								//활
	AT_PSV_NEW_ATK_SPD_GUN,								//총
	AT_PSV_NEW_ATK_SPD_LAUNCHER,				    //런쳐
	AT_PSV_NEW_ATK_SPD_TWIN_GUN,						//쌍총
	AT_PSV_NEW_ATK_SPD_STAFF,							//지팡이
	AT_PSV_NEW_ATK_SPD_WAND,							//완드
	AT_PSV_NEW_ATK_SPD_KATAR,							//카타르
	AT_PSV_NEW_ATK_SPD_TWIN_SWD,				   //이도류
	AT_PSV_NEW_ATK_SPD_CROSSBOW,				  //석궁
	AT_AFTER_PASSIVE_SKILL_2ND = 132,						
#ifdef __EXPERIENCE_ITEM
	AT_PSV_EXPERIENCE_ITEM = 133,
#endif
	AT_MAX
} ;
