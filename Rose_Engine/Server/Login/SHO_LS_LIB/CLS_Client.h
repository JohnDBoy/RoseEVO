...
// 2007.03.12/김대성/추가 - 일본 웹 ActiveX 연동
	bool    Recv_cli_LOGIN_REQ2 ( t_PACKET *pPacket );
//-------------------------------------
...
public :
	...
	sqlTIMESTAMP m_timeStartTime;  //과금 시작시간..
	sqlTIMESTAMP m_timeEndTime;    // 과금 끝시간...
...
//-------------------------------------
// 2007.03.12/김대성/추가 - 일본 웹 ActiveX 연동
	bool Send_lsv_LOGIN_REPLY2(BYTE *pszAccount, BYTE *pMD5PW);
//-------------------------------------
...
//-------------------------------------
// 2007.03.12/김대성/추가 - 일본 웹 ActiveX 연동
	bool Send_lsv_LOGIN_REPLY2 (int iSocketIDX, BYTE *pszAccount, BYTE *pMD5PW);
//-------------------------------------
