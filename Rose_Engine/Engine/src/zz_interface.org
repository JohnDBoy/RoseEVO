 ...
 * @date    28-nov-2002
 *
 * $Header: /engine/src/zz_interface.cpp 240   04-11-08 2:05p Choo0219 $
 */
...
void initZnzin (void)
{
	...
	if (dxversion < DX_VERSION_9B) {
		MessageBox( NULL, "DirectX Version mismatch!", "Error", MB_OK | MB_TOPMOST);
		exit(EXIT_FAILURE);
	}
...
int beginScene ( void )
{
    ...
    znzin->screen_sfx.pre_render();             //test
...
int getVisibleVelocity ( HNODE hVisible, float vVelocityVector[3] )
{
	...
	vVelocityVector[0] = velocity.x;
	vVelocityVector[1] = velocity.y;
	vVelocityVector[2] = velocity.z;
